...
- (NSString *)toolbarTitle
{
    ...
    {
        NSString *singlePhotoText = self.singlePhotoText ?: NSLocalizedStringFromTable(@"picker.selection.single-photo", @"GMImagePicker", @"1 Photo Selected");
        return singlePhotoText;
    }
    else if (nVideos>1)
    {
    ...
    {
        NSString *singleVideoText = self.singleVideoText ?: NSLocalizedStringFromTable(@"picker.selection.single-video", @"GMImagePicker", @"1 Video Selected");
        return singleVideoText;
    }
    else
    {
        return nil;

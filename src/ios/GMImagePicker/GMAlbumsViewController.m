...
- (void)viewDidLoad
{
    ...
    {
        NSString *cancelButtonText = self.picker.discardText ?: NSLocalizedStringFromTable(@"picker.navigation.cancel-button", @"GMImagePicker", @"Cancel");
        self.navigationItem.leftBarButtonItem =
        [[UIBarButtonItem alloc] initWithTitle:cancelButtonText
                                         style:UIBarButtonItemStylePlain
                                        target:self.picker
                                        action:@selector(dismiss:)];
    }

    NSString *doneButtonText = self.picker.doneText ?: NSLocalizedStringFromTable(@"picker.navigation.done-button", @"GMImagePicker",@"Done");
